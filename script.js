  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule) {
      ...
      const messages = {
        ...
        minlength: 'Please enter at least ' + field.getAttribute('data-minlength') + ' characters.'
      };
    ...
    function validateField(field) {
      ...
      if ((type === 'email' || field.getAttribute('data-validate') === 'email') && !VALIDATORS.email(value)) {
        showError(field, getErrorMessage(field, 'email'));
        return false;
      }

      if ((type === 'tel' || field.getAttribute('data-validate') === 'tel') && !VALIDATORS.tel(value)) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const successMessage = contactForm.querySelector('.form-success-message') || (function () {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Koko Express משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f1bfb1c4-74ef-4f84-8cb6-62afdc44b9e4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f1bfb1c4-74ef-4f84-8cb6-62afdc44b9e4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f1bfb1c4-74ef-4f84-8cb6-62afdc44b9e4';
